<footer metal:define-macro="page_footer">
...
<div class="container">
	...
	<div class="col-md-4 footer-content">
		...
		<ul class="list-inline">
			<li><img class="footer-icons" src="./imgs/visa.svg" alt="VISA"/></li>
			<li><img class="footer-icons" src="./imgs/mastercard.svg" alt="MASTERCARD"/></li>
			<li><img class="footer-icons" src="./imgs/paypal.svg" alt="PayPal"/></li>
		</ul>
	</div>
